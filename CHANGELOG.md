...
- Anchor graph edges at visible node ports, classify active read/write/handoff edges, and hide low-priority support labels until hover, focus, or live activity.
